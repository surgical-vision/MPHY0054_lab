"""One-click launch file for the lab07_task assignment (optionally with RViz).
...
4. The `lab07_task` node where the checkpoint and trajectory logic must be implemented.
...
def generate_launch_description() -> LaunchDescription:
    ...
    rviz_config_file = os.path.join(
        get_package_share_directory('lab07_task'),
        'config',
        'lab07_task.rviz'
    )
    rviz_node = Node(
